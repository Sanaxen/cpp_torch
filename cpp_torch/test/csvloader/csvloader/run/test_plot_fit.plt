...
plot file using 1:3   t "Observation"  with lines linewidth 2 lc "web-blue","predict.dat" using 1:3   t "input"  with lines linewidth 2 lc "web-blue"
replot file using 1:5   t "Observation"  with lines linewidth 2 lc "web-blue","predict.dat" using 1:5   t "input"  with lines linewidth 2 lc "web-blue"
replot file using 1:7   t "Observation"  with lines linewidth 2 lc "web-blue","predict.dat" using 1:7   t "input"  with lines linewidth 2 lc "web-blue"
