...
struct NetImpl : torch::nn::Module {
		...
		fc4(50, y_dim*out_sequence_length)
	{
		...
		auto opt = torch::nn::LSTMOptions(y_dim, hidden_size).layers(3);
...
#ifdef RNN_LAYERS_OPT
	model.get()->add_recurrent(std::string("lstm"), sequence_length, hidden_size, 3);
#else
